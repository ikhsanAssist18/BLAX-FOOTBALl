...
import { OverviewLoadingSkeleton } from "./LoadingSkeleton";
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 md:gap-4">
        <div>
          ...
          <p className="text-sm md:text-base text-gray-600 mt-1">
            Pantau performa platform booking sepak bola Anda
          </p>
        </div>
        ...
        <div className="flex items-center space-x-2 md:space-x-3">
          ...
          <select
            ...
            className="px-2 md:px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-xs md:text-sm"
          >
          ...
          >
            <RefreshCw
              className={`w-3 h-3 md:w-4 md:h-4 md:mr-2 ${refreshing ? "animate-spin" : ""}`}
            />
