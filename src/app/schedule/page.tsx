        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="bg-white rounded-xl p-6 shadow-md border border-sky-100 animate-pulse"
              >
                <div className="flex items-center">
          ...
          {/* Skeleton Filter */}
          <div className="bg-white rounded-xl shadow-md border border-sky-100 p-6 mb-8 animate-pulse">
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-sky-400 to-blue-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          {/* Header */}
          <div className="text-center mb-8 bg-white/5 backdrop-blur-sm border border-white/10 p-3 rounded-2xl">
            <h1 className="text-4xl font-bold bg-gradient-to-r from-sky-700 to-blue-700 bg-clip-text text-transparent mb-4">
              Jadwal Pertandingan
            </h1>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="min-w-[160px]">
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 bg-white text-gray-900 text-sm"
                  >
                    {venues.map((venue) => (
          ...
          <div className="mb-6">
            <p className="text-gray-600 bg-white/5 backdrop-blur-sm border border-white/10 p-3 rounded-2xl">
          ...
          {filteredAndSortedMatches.length === 0 && (
            <div className="bg-white rounded-xl shadow-xl border border-sky-100 p-12 text-center">
